...
import { getRandomInt, logIn, logOut } from '../support/helpers'
  ...
  context('When a user enters the log in page', () => {
    ...
    describe('and is an invalid user', () => {
      it('should fail if the password doesn\'t match db record', () => {
        cy.get('#email')
          .type(Users.invalidPasswordUser.email)
        cy.get('#password')
          .type(Users.invalidPasswordUser.password)
        cy.get('#submitBtn')
          .click()
        cy.url()
          .should('include', '/auth')
      ...
      it('should fail if the email doesn\'t exist in the db', () => {
        cy.get('#email')
          .clear()
          .type(Users.invalidEmailUser.email)
        cy.get('#password')
          .type(Users.invalidEmailUser.password)
        cy.get('#submitBtn')
          .click()
        cy.url()
          .should('include', '/auth')
      ...
      it('should fail if the email is not of valid format', () => {
        cy.get('#email')
          .clear()
          .type(Users.invalidEmailFormatUser.email)
        cy.get('#password')
          .clear()
          .type(Users.invalidEmailFormatUser.password)
        cy.get('#submitBtn')
          .click()
          .url()
          .should('include', '/auth')
      ...
      it('should fail if the password is not of valid format', () => {
        cy.get('#email')
          .clear()
          .type(Users.invalidPasswordFormatUser.email)
        cy.get('#password')
          .clear()
          .type(Users.invalidPasswordFormatUser.password)
        cy.get('#submitBtn')
          .click()
          .url()
          .should('include', '/auth')
  ...
  context('When a user enters the sign in page', () => {
    ...
    describe('and is an invalid user', () => {
      ...
      it('should fail if the full name is not of valid format', () => {
        cy.get('#email')
          .type(Users.validUser.email)
        cy.get('#fullName')
          .type(Users.invalidFullNameFormatUser.fullName)
        cy.get('#password')
          .type(Users.validUser.password)
        cy.get('#confirmPass')
          .type(Users.validUser.password)
    ...
    describe('and is a valid user', () => {
      ...
      it('should be able to sign up', () => {
        cy.get('#email')
          .type('new' + getRandomInt(1, 100) + '@random.com')
        cy.get('#fullName')
          .type(Users.newUser.fullName)
        cy.get('#password')
          .type(Users.newUser.password)
        cy.get('#confirmPass')
          .type(Users.newUser.password)
        cy.get('form > button')
          .click()
